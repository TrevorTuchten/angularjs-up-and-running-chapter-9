...
describe('timeAgo Filter', function () {
    ...
    it('should respond based on timestamp', function () {
        ...
        Ideally, we would inject a dateProvider into the timeAgo filter, but we are trying to
        keep it simple here. So we will assume that our tests are fast enough to execute in
        mere milliseconds.*/
